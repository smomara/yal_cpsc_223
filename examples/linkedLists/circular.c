...
// create a new circular doubly-linkd list with 1 element
...
// insert an element e into list in direciton dir from head
...
// the removed lements are formed into their own linked list
...
void listDestroy(Elt e) {
    ...
    // note use of pointer address comparision to detect end of loop
